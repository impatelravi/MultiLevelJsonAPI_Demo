...
class TableViewDelegateDataSource: NSObject {
    //variables
...
extension TableViewDelegateDataSource: UITableViewDataSource {
...
extension TableViewDelegateDataSource: UITableViewDelegate {
